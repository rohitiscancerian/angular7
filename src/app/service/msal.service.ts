...
export class MsalService {
    ...
    authority = "https://gphcdevaadb2c.b2clogin.com/" + this.tenantConfig.tenant + "/" + this.tenantConfig.signInPolicy;
    ...
    public login():void{
      this.clientApplication.authority = "https://gphcdevaadb2c.b2clogin.com/" + this.tenantConfig.tenant + "/" + this.tenantConfig.signInPolicy;
      this.authenticate();
    }

    public signup():void{
      this.clientApplication.authority = "https://gphcdevaadb2c.b2clogin.com/" + this.tenantConfig.tenant + "/" + this.tenantConfig.signUpPolicy;
      this.authenticate();
    }
